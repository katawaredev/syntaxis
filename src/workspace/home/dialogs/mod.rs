...
use self::{
    ...
    mise_tools::FreeRuntimeSpaceDialog, new_project::NewProjectDialog, notes::WorkspaceNotesDialog,
...
pub(super) fn HomeDialogs(
    ...
    rsx! {
        ...
        if dialog() == HomeDialog::FreeRuntimeSpace {
            FreeRuntimeSpaceDialog { dialog, on_notice }
        }
