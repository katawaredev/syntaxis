...
pub fn Select(
    ...
    let class = format!(
        "touch-input w-full border border-input bg-background/95 text-foreground shadow-xs outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/35 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 {} {class}",
        size.input_class()
    );
