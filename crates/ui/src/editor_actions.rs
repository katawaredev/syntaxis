    ...
    rsx! {
        DropdownMenu {
            ...
            MenuContent { class: "right-0 w-60",
                ...
                EditorMenuItem { index: 6, icon: AppIcon::Completion, label: "Trigger Completion", suffix: "Mod Space", disabled: true, onclick: move |()| on_action.call(EditorAction::TriggerCompletion) }
                EditorMenuItem { index: 7, icon: AppIcon::GoToDefinition, label: "Go to Definition", suffix: "F12", disabled: true, onclick: move |()| on_action.call(EditorAction::GoToDefinition) }
                EditorMenuItem { index: 8, icon: AppIcon::FindReferences, label: "Find References", suffix: "Shift F12", disabled: true, onclick: move |()| on_action.call(EditorAction::FindReferences) }
                EditorMenuItem { index: 9, icon: AppIcon::FormatDocument, label: "Format Document", suffix: "Shift Alt F", disabled: true, onclick: move |()| on_action.call(EditorAction::FormatDocument) }
                hr {}
                ...
                EditorMenuItem { index: 15, icon: AppIcon::FileDiff, label: "View Changes", disabled: !changed, onclick: move |()| on_action.call(EditorAction::ViewChanges) }
                EditorMenuItem { index: 16, icon: AppIcon::FilePlus, label: "Stage File", disabled: true, onclick: move |()| on_action.call(EditorAction::ToggleStage) }
                hr {}
                EditorMenuItem { index: 17, icon: AppIcon::Revert, label: "Revert File", disabled: !interactive, danger: true, onclick: move |()| on_action.call(EditorAction::Revert) }
            }
        }
    }
}
