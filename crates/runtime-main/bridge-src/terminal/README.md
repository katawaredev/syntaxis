...
`crates/runtime-main/assets/terminal.bundle.js` (browser IIFE format, minified)
...
This generates the runtime-main asset. The generated file is git-ignored — run
...
unchanged. `runtime-main` loads the versioned bridge idempotently when a terminal
