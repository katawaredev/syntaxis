...
pub use browser::{BrowserClipboard, BrowserTerminalSession, MainImagePreview};
#[cfg(any(feature = "host", test))]
pub use files::{HostFilesSession, HostWorkspaceSearch, host_workspace_registry};
pub use preview::{MainPreviewAdapter, MainPreviewTransport};
pub use remote::{
...
pub use terminal::{MainTerminalCommands, MainTerminalCommandsTransport};
...
mod tests {
    #[test]
    fn main_runtime_composes_a_complete_shared_service_graph() {
