...
pub fn use_active_workspace() -> ActiveWorkspace {
    ActiveWorkspace {
...
impl ActiveWorkspace {
    pub fn base(self) -> Option<WorkspaceRecord> {
        (self.base)()
    }
    ...
    pub fn activate(mut self, worktree: WorktreeInfo) {
    ...
    pub fn request_new_agent_session(mut self, workspace_id: WorkspaceId) {
        self.pending_agent_session.set(Some(workspace_id));
    }

    pub fn should_create_agent_session(self, workspace_id: &WorkspaceId) -> bool {
        self.pending_agent_session.peek().as_ref() == Some(workspace_id)
    }

    pub fn complete_agent_session_request(mut self, workspace_id: &WorkspaceId) {
    ...
    pub fn reconcile(mut self, items: Vec<WorktreeInfo>) {
    ...
    pub fn set_base(mut self, workspace: WorkspaceRecord) {
        let unchanged = self
            .base
            .peek()
            .as_ref()
    ...
    pub fn select(mut self, workspace_id: &str) -> bool {
        let selected = self
            .worktrees
            .peek()
            .iter()
    ...
    pub fn forget_worktree(mut self, workspace_id: &str) {
        self.worktrees
            .write()
