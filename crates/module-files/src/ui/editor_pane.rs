...
pub(super) fn EditorPane(
    ...
    let reload_files = files.clone();
    let shortcut_files = files;
                                    ...
                                    button {
                                        ...
                                        onclick: move |_| {
                                            if let Some(workspace) = workspace() {
                                                reload_document(reload_files.clone(), workspace, reload_path.clone(), documents, toast);
                                            }
                                        },
                                        "Reload"
                                    }
