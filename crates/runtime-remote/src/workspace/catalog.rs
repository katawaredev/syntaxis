...
struct RemoteWorkspaceCatalog;

pub(crate) fn workspace_catalog() -> PortHandle<dyn WorkspaceCatalogPort> {
    PortHandle::new(RemoteWorkspaceCatalog)
}
...
#[async_trait(?Send)]
impl WorkspaceCatalogPort for RemoteWorkspaceCatalog {
...
#[async_trait(?Send)]
impl RuntimeStatusPort for RemoteWorkspaceCatalog {
...
#[async_trait(?Send)]
impl WorkspaceFolderPort for RemoteWorkspaceCatalog {
...
#[async_trait(?Send)]
impl WorkspaceClonePort for RemoteWorkspaceCatalog {
    async fn start(
        &self,
        ...
        Ok(Box::new(RemoteWorkspaceCloneStream { socket }))
    }
}

struct RemoteWorkspaceCloneStream {
    socket: dioxus::fullstack::Websocket<CloneClientMessage, CloneServerMessage>,
}

#[async_trait(?Send)]
impl WorkspaceCloneStream for RemoteWorkspaceCloneStream {
...
#[async_trait(?Send)]
impl WorkspaceProjectPort for RemoteWorkspaceCatalog {
...
#[async_trait(?Send)]
impl WorkspaceManagementPort for RemoteWorkspaceCatalog {
