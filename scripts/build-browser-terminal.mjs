...
const destination = resolve(outputDir, "browser-terminal.bundle.js");
const stamp = resolve(outputDir, "browser-terminal.bundle.stamp");
...
if (
  ...
  console.log(`Browser terminal bundle is current (${cacheKey.slice(0, 12)})`);
  process.exit(0);
}
...
console.log(`Built browser just-bash bundle (${cacheKey.slice(0, 12)})`);
