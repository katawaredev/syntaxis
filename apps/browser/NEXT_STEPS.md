...
The output is `target/dx/syntaxis-browser/release/web/public`. The included
`build-vercel.sh` builds the editor and all three browser bridges and copies that static artifact
to `apps/browser/dist`.
